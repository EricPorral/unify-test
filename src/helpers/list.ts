...
export const infogrid: gridType[] = [
    {
        ...
        image: '/itemgrid1.png',
        title: 'Hotéis',
        desc: 'Gestão de iluminação e ar-condicionado em áreas comuns reservadas para hóspedes, monitoramento do consumo de energia e utilidades, monitoramento do armazenamento em câmaras frias e temperaturas de caldeiras para fornecimento de água quente'
    },
    {
        key: 2,
        image: '/itemgrid2.png',
...
export const Checkphrases: CheckType[] = [
    {desc: 'Software unificado com todos os dados de monitoramento'},
    {desc: 'Construção de hardwares personalizados'},
    {desc: 'Compatibilidade com diversos segmentos de mercado'},
